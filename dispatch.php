...
// echo $eachCarId . "<br>"; 
	...
	$insertDispatchedSuccess = $conn-> query($sql);
	...
	$conn->close();
	if($insertDispatchedSuccess == true && $updateSuccess == true &&
	  $insertDispatchedSuccess == true){
		header("location: logcall.php"); 
	}
	}
?>
  ...
  <section class="mt-3">
    <form action="<?php echo htmlentities($_SERVER["PHP_SELF"]) ?>" method="post">
      <div class="form-group row">
       ...
       <div class="form-group row"> <div class="offset-sm-4 col-sm-8">
